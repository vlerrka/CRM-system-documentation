...
const config = {
  ...
  organizationName: 'vlerrka', // Usually your GitHub org/user name.
  projectName: 'CRM-system-documentation', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/vlerrka/CRM-system-documentation/edit/main/',
        },
        blog: false,
        theme: {
